...
<style>
    ...
    .crash-form button:hover {
        background: #0a6ebf;
    }

    .crash-form button:active {
        background: #045698;
    }
...
<div class="error">
    <h2>500 :(</h2>
    <p>Seems Like we have an internal issue, Please tell us more to batter understand the issue</p>
</div>
<div class="container">
    <div class="">
        <form action="{{\LarvaBug\Facade\LarvaBug::feedbackUrl()}}" method="POST"
            class="crash-form"
        >
            <input type="hidden" name="exceptionId" value="{{\Illuminate\Support\Facades\Request::get('exceptionId')}}" required>
            <label>
                <span>@lang('NAME:')</span>
            ...
            <label>
                <span>@lang('WHAT HAPPENED?:')</span>
                <textarea name="message" class="form-control"
                    rows="8"
                ></textarea>
            </label>
            <button type="submit">
                @lang('Submit Crash Report')
            </button>
        </form>
    </div>
...
<span style="float: right; margin-right: 20px;">
        Powered By: <img style="max-width: 30px;vertical-align: middle;" src="http://dev.larvabug.com/assets/images/bug-icon.png" alt=""> LarvaBug
     </span>
<script>
